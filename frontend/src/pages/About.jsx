...
const About = () => {
  ...
  return (
    <>
      <section className="w-full px-5 gap-7 flex flex-col min-h-screen py-8 lg:px-8 justify-center items-center">
        <div>
          <h1
          ...
          <p className="text-xl text-stone-600">
            Welcome to BidBazaar, the ultimate destination for online auctions
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            At BidBazaar, our mission is to revolutionize the way people buy and
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Founded by Enayat,Saad and Ammar, BidBazaar was born out of a passion for
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Whether you're looking to buy, sell, or simply explore, BidBazaar
